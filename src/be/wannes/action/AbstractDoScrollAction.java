...
public abstract class AbstractDoScrollAction extends AnAction {
    ...
    public void actionPerformed(AnActionEvent e) {
        ...
        doAction(project);
        addListener(editor, project);
    }

    protected abstract void doAction(Project project);

    private void addListener(Editor editor, Project project) {
